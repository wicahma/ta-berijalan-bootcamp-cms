...
@section('body')
    <div class="space-y-3">
        <form action="{{ route('req.resource.create') }}" method="POST">
            @csrf
            ...
            <div class="border border-gray-200 dark:border-gray-700 rounded-xl overflow-hidden">
                <section class="">
                    <div class="p-4 mx-auto max-w-2xl lg:py-5">
                        <h2 class="mb-4 text-xl font-bold text-gray-900 dark:text-white">Tambahkan Resource Baru</h2>
                        <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <input type="email" name="email" id="email"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    placeholder="berijalan@bakwankawi.co" required="">
                            </div>
                            <div class="w-full">
                                <label for="npk"
                                ...
                                <input type="text" name="npk" id="npk"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    placeholder="NPK Resource" required="">
                            </div>
                            <div class="w-full">
                                ...
                                <input type="text" name="phone_number" id="phone_number"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    placeholder="084578965712" required="">
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <select id="role_id" name="role_id"
                                    ...
                                    <option value="3">Bussiness Analyst</option>
                            ...
                            <div>
                                ...
                                <select id="category_id" name="category_id"
                                    ...
                                    <option value="2">Ungraded</option>
                                </select>
                            </div>
